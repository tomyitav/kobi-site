...
export const TeamContent = () =>
    <div className="row">
        <div className="col-sm-8">
            <ul>
                <li>אינסיווט כמאל - מהנדס אזרחי</li>
                <li>ארקין אלי - מהנדס אזרחי</li>
                <li>ברוך איתמר - מהנדס אזרחי</li>
                <li>גוברמן אלכס - מהנדס אזרחי</li>
                <li>וייסרוז אורי - מהנדס אזרחי</li>
                <li>חדד אביתר - הנדסאי בניין</li>
                <li>לויקו יהודה - מהנדס אזרחי</li>
                <li>ליס ארקדי - מהנדס אזרחי</li>
                <li>קומן שמוליק - אדריכל ומתאם תכנון</li>
                <li>שובל נופר - מהנדסת אזרחית ומתאמת תכנון</li>
